 ...
 *
 */
public class ListUser1 extends JDialog {
	...
	//private String[] colName = { "卡号", "姓名", "性别", "电话","身份证号","年龄", "地址", "权限" };
	private String[] colName={"卡号", "姓名","性别","电话", "身份证号","年龄","权限","状态"};
	private JScrollPane sp;

	public ListUser1(String idcard,JFrame jf) {
		super(jf,true);
		setTitle("查询客户信息");
		setSize(600, 400);
		setResizable(false);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {//获得客户信息
				User eb = new User();
	...
	private void getListData(User emp) {//获得客户信息并复制于table控件
		List<User> list = new UserDao().getUsers1(emp);
		...
		for (int i = 0; i < data.length; i++) {
			...
			String r = "客户";
			String p="";
			if(eb.getState().equals("2"))
				p="激活";
			if(eb.getState().equals("3"))
				p="挂失";
